    ...
    <div>
      ...
      {isDownMD ? (
        <div style={{ marginTop: 50, paddingRight: "5%", paddingLeft: "5%" }}>
          ...
          <Row>
            <Title level={1} style={SubTitleStyle}>
              Booking
            </Title>
          </Row>
          <Row>
          ...
          <Row>
            <Text style={textStyle}>+90 216 422 48 01</Text>
            <Text style={textStyle}>&nbsp;|&nbsp;</Text>
        ...
        <div
          style={{ paddingTop: 300, paddingRight: "15%", paddingLeft: "15%" }}
        >
